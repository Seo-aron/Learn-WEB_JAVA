...
%>
	...
	<jsp:setProperty name="mb" property="id" value='<%=request.getParameter("id") %>' />
	<jsp:setProperty name="mb" property="pw" value='<%=request.getParameter("pw") %>' />
	<jsp:setProperty name="mb" property="name" value='<%=request.getParameter("name") %>' />
	<jsp:setProperty name="mb" property="email" value='<%=request.getParameter("email") %>' />
<%
