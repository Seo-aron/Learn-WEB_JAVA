...
public class Arr02 {
	public static void main(String[] args) {
		...
		//double실수값들 9.5, 7.0, 13.6, 7.5, 10.0 을 초깃값으로 갖는
		//data배열 생성
		double[] data = new double[] {9.5, 7.0, 13.6, 7.5, 10.0};
		//				{9.5, 7.0, 13.6, 7.5, 10.0};
			
		//data배열에 최댓값 하나를 최종 저장할 변수 max선언
		double max; //0.0
		
		//for반복문을 수행하기 전에 data배열에 0 index위치의 9.5를 꺼내서 
