...
예제. 구현 객체가 자식인터페이스 참조변수에 저장되면(업캐스팅되면)
...
//InterfaceC자식인터페이스를 구현받아 설계한 InterfaceCImpl자식클래스 설계
...
public class ExtendsExample {
	...
	public static void main(String[] args) {
		//InterfaceCImpl자식클래스의 객체 생성
		InterfaceCImpl imCImpl = new InterfaceCImpl();
		
		//업캐스팅 가능할까요?
		//부모인터페이스 자료형의 참조변수선언후에  자식객체생성후 주소번지 저장
